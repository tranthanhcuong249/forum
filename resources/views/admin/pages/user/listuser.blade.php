            ...
            <div class="modal-dialog">
                <div class="modal-content none_radius">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title" style="text-transform: uppercase;">Chỉnh Sửa <span class="titleUser" ></span></h4>
                            ...
                            <form>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control roleUser" name="role">
                                        ...
                                        <option class="qldh" value="4">Quản lý đơn hàng</option>
                                        <option class="customer" value="0">Thành Viên</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control statusUser" name="status">
                                        <option class="ht" value="0">Hiển thị</option>
                                        <option class="kht" value="1">Không hiển thị</option>
                                    </select>
                                </div>
                                <div class="form-actions form-group">
                                    <input type="button" class="btn btn-primary updateUser" style="font-size: 11px; border-radius:2px;
