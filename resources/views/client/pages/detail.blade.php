    ...
    <div class="banner-bootom-w3-agileits py-5">
        <div class="container py-xl-4 py-lg-2">
            ...
            <div class="row">
                ...
                <div class="col-lg-7 single-right-left simpleCart_shelfItem" style="margin-bottom: 20px !important;">
                    ...
                    <div class="single-infoagile">
                        <ul>
                            ...
                            <li class="mb-3">
                                Khuyến mãi từ 100.000 VNĐ/tháng
                            </li>
                            <li class="mb-3">
                                Ưu đãi giảm 5% khi thanh toán qua ví AirPay
                            </li>
                        </ul>
                    </div>
                    <div class="product-single-w3l">
                        <p class="my-sm-4 my-3">
                            <i class="fas fa-retweet mr-3"></i>Thanh toán qua ví AirPay
                        </p>
                    </div>
